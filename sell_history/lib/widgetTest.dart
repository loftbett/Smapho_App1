...
class _DialogTestState extends State<DialogTest> {
  ...
  void openDialog(BuildContext context) {
    showDialog<Answer>(
        ...
        builder: (BuildContext context) => new SimpleDialog(
              title: Text('Dialog'),
              children: [
                createDialogOption(context, Answer.YES, "YES"),
                createDialogOption(context, Answer.NO, "NO"),
              ],
            )).then((value) {
      switch (value) {
        case Answer.YES:
  ...
  Widget createDialogOption(BuildContext context, Answer answer, String str) {
